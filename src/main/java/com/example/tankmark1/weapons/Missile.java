...
public class Missile extends Projectile {
    ...
    public Missile(double x, double y, double dx, double dy, double angle, Tank owner) {
        super(x, y,"/weapons_png/rocket.png",
                dx, dy,
                5,angle,Missile.damage,
                owner, "/explosion_sprite_Sheets/torpedoHitL2.png","/explosionSound.mp3",5,2,80,80,30,30); // High-speed projectile for a laser
